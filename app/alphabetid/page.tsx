  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-4 pb-24">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mt-6">
        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Letter {letter} Sign</h2>
        <div className="w-40 h-40 bg-gray-100 dark:bg-gray-700 rounded-xl flex items-center justify-center text-5xl text-indigo-500 mx-auto mb-4">
          {sign}
        </div>
        <p className="text-gray-700 dark:text-gray-300 mb-4">Practice the ISL hand sign for &ldquo;{letter}&rdquo;.</p>
