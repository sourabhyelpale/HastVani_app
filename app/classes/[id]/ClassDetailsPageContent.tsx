            ...
            <div>
              {isTeacher && (
                <div className="mb-6 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-end">
                  <button
                    onClick={() => router.push(`${ROUTES.CLASSES}/${classId}/modules`)}
                    className="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 font-medium hover:bg-gray-50 dark:hover:bg-gray-800 transition"
                  >
                    Manage Modules
                  </button>
                  <button
